...
Active development of these R packages is temporarily suspended. Until further notice, these packages should
...
In addition, work **primarily** based on this package should **not** be presented at academic conferences or similar scholarly venues.
